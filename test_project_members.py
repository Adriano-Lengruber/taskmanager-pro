...
def test_list_members(token, project_id):
    ...
    if response.status_code == 200:
        ...
        print(f"✅ Membros listados: {len(members)} encontrados")
        return members
    else:
...
def main():
    ...
    # Simula IDs de usuários (normalmente obtidos da API)
    # Para este teste, vamos assumir IDs sequenciais
    member1_id = 2  # Assumindo que o usuário de teste é ID 1
    member2_id = 3
